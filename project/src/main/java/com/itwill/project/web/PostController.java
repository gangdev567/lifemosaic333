...
public class PostController {
	...
	@GetMapping("/list/")
	public void listBySubCategoryId(Model model, Criteria cri,
			@RequestParam(name = "sub_category_id") Long sub_category_id,
			@RequestParam(value = "pageNo", defaultValue = "1") Long pageNum) {
	...
	@GetMapping("/delete")
	public String delete(@RequestParam(name = "post_id") Long post_id,
			@RequestParam(name = "sub_category_id") Long sub_category_id) {
