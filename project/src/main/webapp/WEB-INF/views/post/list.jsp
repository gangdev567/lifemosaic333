									...
									<c:forEach var="p" items="${posts}">
										<li class="post-item">
											<div class="post-details">
												<div class="post-info">
													<span class="post-nickname"> <a href="#"
														class="text-decoration-none text-dark">${p.nickname}</a>
													</span> <span class="post-view-count"> <i
														class="far fa-eye"></i> ${p.view_count} views
													</span>
												</div>
												<h3 class="post-title">
													...
													<a href="${postDetails}"
														...
														style="transition: color 0.3s ease; text-decoration: none;">
														<span class="hover-text">${p.title}</span>
													</a>
												</h3>
												<p class="post-tag">
													<a href="#" class="text-decoration-none text-dark">#태그
														미정</a>
												</p>
											</div>
