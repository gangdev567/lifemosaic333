...
document.addEventListener('DOMContentLoaded', function() {
	...
	function makePostHtmlTemplet(pageNumber) {
			...
			<div class="my-3 ms-2">
			        ...
			        <div class="d-flex px-2">
			            ...
			            <div class="d-flex flex-sm-fill align-items-center">    
			                <img src="../setting/settingImg?fileName=${searchData[i - 1].profile}" alt="${searchData[i - 1].nickname}" class="me-2 rounded-circle" style="width :20px;height: 20px;border: 1px solid lightgray;">
			                <!-- 닉네임 -->
			                <span class="small">
			                    <strong class="d-block text-gray-dark">${searchData[i - 1].nickname}</strong>
			                </span>
			            </div>
			            ...
			            <div class="d-flex align-items-center text-secondary" style="font-size:12px;">
			                ...
			                <span class="me-4 time fw-bold">${searchData[i - 1].created_time}</span>
			            </div>
			        </div>
			    </div>
			        <hr/>
		...
		console.log("뭐 받아옴 : ", timeElements);
